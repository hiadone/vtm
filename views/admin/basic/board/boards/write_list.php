            ...
            <div class="collapse in" id="boardtab1">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            PC - <input type="number" class="form-control" name="list_count" value="<?php echo set_value('list_count', element('list_count', element('data', $view)) + 0); ?>" />,
                            모바일 - <input type="number" class="form-control" name="mobile_list_count" value="<?php echo set_value('mobile_list_count', element('mobile_list_count', element('data', $view)) + 0); ?>" />,
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            PC - <input type="number" class="form-control" name="page_count" value="<?php echo set_value('page_count', element('page_count', element('data', $view)) + 0); ?>" />,
                            모바일 - <input type="number" class="form-control" name="mobile_page_count" value="<?php echo set_value('mobile_page_count', element('mobile_page_count', element('data', $view)) + 0); ?>" />,
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            PC - <input type="number" class="form-control" name="new_icon_hour" value="<?php echo set_value('new_icon_hour', element('new_icon_hour', element('data', $view)) + 0); ?>" />시간,
                            모바일 - <input type="number" class="form-control" name="mobile_new_icon_hour" value="<?php echo set_value('mobile_new_icon_hour', element('mobile_new_icon_hour', element('data', $view)) + 0); ?>" />시간,
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            조회수가
                            PC - <input type="number" class="form-control" name="hot_icon_hit" value="<?php echo set_value('hot_icon_hit', element('hot_icon_hit', element('data', $view)) + 0); ?>" />,
                            모바일 - <input type="number" class="form-control" name="mobile_hot_icon_hit" value="<?php echo set_value('mobile_hot_icon_hit', element('mobile_hot_icon_hit', element('data', $view)) + 0); ?>" />
                            이상이면 Hot 아이콘이 보입니다.<br />
                            PC - <input type="number" class="form-control" name="hot_icon_day" value="<?php echo set_value('hot_icon_day', element('hot_icon_day', element('data', $view)) + 0); ?>" />일,
                            모바일 - <input type="number" class="form-control" name="mobile_hot_icon_day" value="<?php echo set_value('mobile_hot_icon_day', element('mobile_hot_icon_day', element('data', $view)) + 0); ?>" />일
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            PC - <input type="number" class="form-control" name="subject_length" value="<?php echo set_value('subject_length', element('subject_length', element('data', $view)) + 0); ?>" />글자,
                            모바일 - <input type="number" class="form-control" name="mobile_subject_length" value="<?php echo set_value('mobile_subject_length', element('mobile_subject_length', element('data', $view)) + 0); ?>" />글자
                            이상은 목록에서만 잘려보입니다.
            ...
            <div class="box-table">
                ...
                <div class="collapse in" id="boardtab2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" name="gallery_cols" value="<?php echo set_value('gallery_cols', element('gallery_cols', element('data', $view)) + 0); ?>" />
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            가로 <input type="number" class="form-control" name="gallery_image_width" value="<?php echo set_value('gallery_image_width', element('gallery_image_width', element('data', $view)) + 0); ?>" />px,
                            세로 <input type="number" class="form-control" name="gallery_image_height" value="<?php echo set_value('gallery_image_height', element('gallery_image_height', element('data', $view)) + 0); ?>" />px
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            가로 <input type="number" class="form-control" name="mobile_gallery_image_width" value="<?php echo set_value('mobile_gallery_image_width', element('mobile_gallery_image_width', element('data', $view)) + 0); ?>" />px,
                            세로 <input type="number" class="form-control" name="mobile_gallery_image_height" value="<?php echo set_value('mobile_gallery_image_height', element('mobile_gallery_image_height', element('data', $view)) + 0); ?>" />px
                        </div>
                        <div class="col-sm-2">
