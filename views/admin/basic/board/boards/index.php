                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="point_read[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('point_read', element('meta', $result))) + 0; ?>" style="width:50px;" />
                                <input type="text" name="point_write[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('point_write', element('meta', $result))) + 0; ?>" style="width:50px;" />
                                <input type="text" name="point_comment[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('point_comment', element('meta', $result))) + 0; ?>" style="width:50px;" />
                                <input type="text" name="point_download[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('point_download', element('meta', $result))) + 0; ?>" style="width:50px;" />
                            </td>
